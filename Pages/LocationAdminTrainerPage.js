                        ...
                        <View style={{
                            ...
                            <View style={{flex: 1}}>
                                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                                    <View style={{marginLeft:20, borderBottomWidth:1, borderBottomColor: "#E4E4E4", paddingBottom:30, width:'75%'}}>
                                    ...
                                    <View style={{marginLeft:20,  paddingTop:10, paddingBottom:10, width:'75%'}}>
                                       <View style={{flexDirection:"row", padding: 5}}>
                                        ...
                                        {this.state.edit ? 
                                            ...
                                            />:
                                            <Text style = {{color: this.state.email =="Weight (lbs)" ? "#D5D5D5" : "black"}}> 
                                        ...
                                        {this.state.edit ? 
                                            ...
                                            />:
                                            <Text style = {{color: this.state.phone=="Weight (lbs)" ? "#D5D5D5" : "black"}}> 
