...
export default class AdminDieticianPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            isModalVisible: false,
            calls: [
                {id:1,  name: "Abby Cohen", gym: "Balance Nutrition"},
                {id:2,  name: "Alicia Yang", gym: "Free Method Nutrition"} ,
                {id:3,  name: "Charles Wang", gym: "Horizon Nutrition"} ,
                {id:4,  name: "Grace Jeong", gym: "Renu Health"} ,
                {id:5,  name: "Ilya Ermakov", gym: "Balance Nutrition"} ,
                {id:6,  name: "Lauren Charney", gym: "Renu Health"} ,
